...
$vehicles = [
    ['key' => 'vehicle16ImageUrl', 'videoKey' => 'vehicle16VideoUrl', 'title' => 'Xe Ford Transit 16 Chỗ', 'items' => ['Xe đời mới 2026.', 'Nâng cấp từ dòng 18 chỗ xuống còn 16 chỗ.', 'Ngả lưng siêu rộng rãi, thoải mái.', 'Hệ thống bánh đôi vận hành đầm chắc, bám đường tốt.', 'Đầu tư karaoke thông minh.', 'Phù hợp với: Du lịch gia đình, đưa đón sân bay, công tác, tour du lịch, đưa đón khách.']],
    ['key' => 'vehicle29ImageUrl', 'videoKey' => 'vehicle29VideoUrl', 'title' => 'Xe Tracomeco 29 chỗ', 'items' => ['Xe đời mới 2026.', 'Bền bỉ và cách âm hoàn hảo.', 'Hệ thống giảm xóc bầu hơi lướt đi êm ái nhiều địa hình.', 'Ghế ngồi bọc da cao cấp.', 'Khoảng cách ghế rộng rãi.', 'Đầu tư dàn âm thanh, Karaoke sống động.', 'Phù hợp: Đoàn công ty nhỏ, đại gia đình đi tour du lịch chất lượng cao.']],
    ['key' => 'vehicleLimoImageUrl', 'videoKey' => 'vehicleLimoVideoUrl', 'title' => 'Xe KimLong Limousine 29 Ghế VIP', 'items' => ['Xe đời mới 2026 chuẩn hạng thương gia.', 'Nâng cấp từ dòng 45 chỗ xuống còn 29 chỗ VIP.', 'Hệ thống ghế bọc da chỉnh điện thông minh.', 'Tích hợp bệ nâng hạ đùi giúp thư giãn cơ thể tối đa.', 'Tích hợp bàn làm việc cá nhân.', 'Cổng sạc điện thoại riêng biệt tại mỗi ghế.', 'Đầu tư Karaoke chuyên nghiệp với âm thanh đỉnh cao.', 'Phù hợp: Đón tiếp đối tác VIP, chuyên gia, trải nghiệm du lịch cao cấp, thoải mái.']],
    ['key' => 'vehicle45ImageUrl', 'videoKey' => 'vehicle45VideoUrl', 'title' => 'Xe Kim Long 45 Chỗ', 'items' => ['Xe đời mới nhất 2026.', 'Di chuyển số lượng lớn nhưng chất lượng tuyệt đối.', 'Khoang hành khách siêu rộng với tầm nhìn panorama toàn cảnh cực thoáng.', 'Hệ thống điều hòa đa chiều làm mát sâu đến từng vị trí ngồi.', 'Cốp xe siêu rộng chứa trọn vẹn hành lý của cả đoàn.', 'Karaoke chuyên nghiệp với âm thanh sống động.', 'Phù hợp: Teambuilding, trường học, đoàn tham quan du lịch lớn.']],
];
